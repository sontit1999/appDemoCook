...
class PreferanceViewModel : BaseViewModel(){
    ...
    fun getArrItemTypeFood(): MutableLiveData<MutableList<TypeFood>> {
        val list = listOf(
            ...
            (TypeFood(R.drawable.protein, "Minerals", "Minerals are the exogenous chemical elements indispensable for life.",false)),
            ...
            (TypeFood(R.drawable.protein, "Protein", "Vitamins are organic molecules essential for an organism that are not classified.",false))
        ).toMutableList()
